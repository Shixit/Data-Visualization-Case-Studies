...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        # Use groupby to create relevant data for plotting
        exp_rec = recession_data.groupby('Vehicle_Type')['Price'].sum()
        R_chart3 = dcc.Graph(
        ...
        # Create relevant data and plot

        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1), html.Div(children=R_chart2)], style={'flex': 1}),
    ...
    # TASK 2.6: Create and display graphs for Yearly Report Statistics
        ...
        exp_data = yearly_data.groupby('Vehicle_Type')['Price'].sum().reset_index()
